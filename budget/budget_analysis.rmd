...
(
  facet <-
    ...
    labs(main="DoD RDT&E Aircraft Engine Spending By Project",
         caption="Source: CSIS analysis based on RDT&E budget documents (PB 2000–21), which can be found at https://comptroller.defense.gov/Budget-Materials/. ") +
    xlab("Fiscal Year") +
    ylab("Constant 2021 $") + 
    geom_vline(
      xintercept = 2021,
...
stage$stagename<-factor(stage$stagename)
 levels(stage$stagename)<-list(
      '(6.1) Basic Research'=
        c('(6.1) Basic Research',
          "Basic Research (6.1)" ),
      '(6.2) Applied Research'=
        c('(6.2) Applied Research',
      ...
      '(6.4) Advanced Component Development & Prototypes'=
        c('(6.4) Advanced Component Development & Prototypes',
          "Advanced Component Development & Prototypes (6.4)",
          "Advanced Component Development & Prototypes (6.4)"),
      '(6.5) System Development & Demonstration'=c('(6.5) System Development & Demonstration',
                                                   "System Development & Demonstration (6.5)"  ),
      '(6.7) Operational Systems Development'=c('(6.7) Operational Systems Development',
