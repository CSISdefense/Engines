...
ggsave600dpi("charts//psr_ServiceArea.svg", RnDphase,
             width=12, height= 6, units="in",size=12, lineheight=1.2
)
# 
# 
...
# 
# topplat<-engine_contracts %>% filter(SimpleArea=="Aircraft") %>% group_by (Project.Name) %>%
#   summarise(Action_Obligation_OMB23_GDP21=sum(Action_Obligation_OMB23_GDP21),
#             Action_Obligation_2020=sum(ifelse(Fiscal_Year==2020,Action_Obligation_OMB23_GDP21,0))
#             )%>% mutate(rank_total=rank(desc(Action_Obligation_OMB23_GDP21)),
#                         rank_2020=rank(desc(Action_Obligation_2020)))
...
#   ifelse(engine_contracts$Project.Name %in% topplat$Project.Name[topplat$rank_2020<=7 | topplat$rank_total<=7],
#          engine_contracts$Project.Name,NA)
# engine_contracts$TopAircraftProject[is.na(engine_contracts$TopAircraftProject) & !is.na(engine_contracts$Project.Name)]<-
#   "Other Labeled Project"
