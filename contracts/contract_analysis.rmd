...
(
  ColorOfMoney<-build_plot(
    ...
    theme(legend.position = "bottom")+
    labs(y="Obligations (Constant 2021 $s)")#+
    # facet_grid(ColorOfMoney~.,scales="free_y",space="free_y")
)
...
ggsave600dpi(ColorOfMoney,file="charts/ColorOfMoney.png",width=5,height=6,size = 11)
ggsave600dpi(ColorOfMoney,file="charts/ColorOfMoney.svg",width=3.25,height=6,size = 11)
